...
module.exports = {
  ...
  // Style options.
  styleSRC: "./src/scss/style.sass", // Path to main .scss file.
  ...
  // JS Custom options.
  jsCustomSRC: "./src/js/script.js", // Path to JS custom scripts folder.
  ...
  // Watch files paths.
  watchStyles: "./src/scss/**/*.sass", // Path to all *.scss files inside css folder and inside them.
